...
const loginLimiter = rateLimit({
    ...
    max: 5, // Limite chaque IP à 5 évènements de connection par "fenêtre"
    message:
        "Trop d'échecs de connection ont eu lieu depuis cet IP,veuillez réessayer après 15 minutes",
